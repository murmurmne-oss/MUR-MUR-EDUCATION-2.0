...
const TRANSLATIONS: Record<Locale, Record<string, string>> = {
  ...
  sr: {
    ...
    "Вопрос {current} из {total}": "Pitanje {current} od {total}",
    ...
    "Чтобы продолжить, ответьте на вопрос.": "Da biste nastavili, odgovorite na pitanje.",
    "Оцените от 1 до {max}": "Ocenite od 1 do {max}",
    "Оценка от 1 до {max}": "Ocena od 1 do {max}",
    ...
    "Изучить следующий урок": "Istraži sledeću lekciju",
    "Контент урока появится совсем скоро.": "Sadržaj lekcije će se pojaviti uskoro.",
    "Ваш браузер не поддерживает элемент audio.": "Vaš pregledač ne podržava audio element.",
    "Перейти к описанию курса": "Pređi na opis kursa",
    "Изображение урока": "Slika lekcije",
    "Отправка...": "Slanje...",
    "Не удалось отправить тест. Попробуйте закрыть и открыть тест снова.": "Nije uspelo slanje testa. Pokušajte da zatvorite i ponovo otvorite test.",
    "Не удалось начать форму. Попробуйте позже.": "Nije uspelo pokretanje forme. Pokušajte kasnije.",
    "Эта форма ещё не содержит вопросов.": "Ova forma još nema pitanja.",
    "Не удалось отправить форму. Попробуйте начать заново.": "Nije uspelo slanje forme. Pokušajte da počnete iznova.",
    "Не удалось отправить форму. Попробуйте позже.": "Nije uspelo slanje forme. Pokušajte kasnije.",
    "Загрузка формы...": "Učitavanje forme...",
    "Результат": "Rezultat",
    "Спасибо за прохождение формы!": "Hvala što ste popunili formu!",
    "Пройти повторно": "Pokušaj ponovo",
    "Пройти форму": "Popuni formu",
    "Формы": "Forme",
